...
class HttpEventScanner {
  ...
  async poll(execId, fn, timeout) {
    ...
    if (timeout) await (0, _utils.sleep)(timeout * 1000);
  ...
  close() {
    ...
    this.pollExecution = (0, _fill.default)(_context = Array(this.pollExecution.length)).call(_context, false);
  }

}

var _default = HttpEventScanner;
